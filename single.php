    ...
    <main id="main__content" class="h-feed col-xs-12 col-md-8" aria-label="<?php _e( 'Main content', 'wp-puxl-blog-classic' ); ?>" role="main">
      ...
      <article id="post__<?php the_ID(); ?>" <?php post_class( 'h-entry hentry' ) ?> aria-labelledby="post__<?php the_ID(); ?>--heading">
          ...
          <div class="meta">
            ...
            <div class="comments">
              <a href="<?php the_permalink() ?>#comments">
                <?php comments_number( '', __( '1 Comment', 'wp-puxl-blog-classic' ), __( '% Comments', 'wp-puxl-blog-classic' ) ); ?></a>.
            </div>
            <?php } ?>
        ...
        <footer>
          ...
          <?php if ( has_category() ) { ?>
          <section class="category-list" aria-labelledby="category--heading">

            <h3 id="category--heading"><?php _e( 'Category', 'wp-puxl-blog-classic' ); ?></h3>
          ...
          <?php if ( has_tag() ) { ?>
          <section class="tag-list" aria-labelledby="tags--heading">

            <h3 id="tags--heading"><?php _e( 'Tags', 'wp-puxl-blog-classic' ); ?></h3>
          ...
          ?>
          <nav class="pagination" aria-label="<?php _e( 'Posts navigation', 'wp-puxl-blog-classic' ); ?>" role="navigation">
            <ul>
              <li>
                ...
                <a class="btn-icn-txt" href="<?php echo get_permalink( $previous_post ); ?>">
                  ...
                  <span><?php _e( 'Previous', 'wp-puxl-blog-classic' ); ?></span>
                  <?php } else { ?>
                  <svg viewBox="0 0 32 32" aria-hidden="true">
                    <!--
              ...
              <li>
                ...
                <a class="btn-icn-txt" href="<?php echo get_permalink( $next_post ); ?>">
                  <?php if ( is_rtl() ) { ?>
                  <span><?php _e( 'Next', 'wp-puxl-blog-classic' ); ?></span>
                  <svg viewBox="0 0 32 32" aria-hidden="true">
                    <!--
                      Puxl icons 1.0: arrow-w.svg - https://puxl.io/puxl-icons
                      Created by @MrKanuel, brought by The Puxl Clan with love from Basque Country
