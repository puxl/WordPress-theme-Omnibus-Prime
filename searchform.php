<?php
/*
 * WordPress PUXL Blog classic search form: searchform.php
 *
...
<form class="searchbox" action="<?php echo home_url( '/' ); ?>" method="get" role="search">
  ...
  <input id="s" name="s" placeholder="<?php _e( 'Search...', 'wp-puxl-blog-classic' ); ?>" value="<?php echo get_search_query() ?>" aria-label="<?php _e( 'Search for something:', 'wp-puxl-blog-classic' ); ?>" type="search">
  ...
  <button id="searchsubmit" class="btn-icn" name="submit" type="submit">
    ...
    <span><?php esc_attr_e( 'Search', 'wp-puxl-blog-classic' ); ?></span>
